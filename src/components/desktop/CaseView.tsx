      ...
      <div className="bg-[#11171C] border border-[#2A363D] rounded-xl flex flex-col overflow-hidden h-[500px] col-span-2">
        {!selectedCase ? (
          ...
          <>
            ...
            <div className="p-4 border-t border-[#2A363D] bg-[#172127] shrink-0 text-right">
              <button disabled={selectedCase.status !== 'open'} className="px-4 py-2 bg-[#45D6BF] hover:bg-[#6DA8FF] text-[#080B0E] font-bold rounded text-sm transition-colors disabled:opacity-50">
                Lập Báo Cáo Chuyển Giao
              </button>
            </div>
          </>
        )}
